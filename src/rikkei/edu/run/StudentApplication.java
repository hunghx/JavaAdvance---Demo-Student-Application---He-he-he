...
public class StudentApplication {
    ...
    private static void initData() {
        studentList.add(new Student("SV001", "Nguyễn Văn An", LocalDate.parse("15/05/2000", ShopValidate.DATE_FORMATTER), Gender.MALE, "0987654321", "an.nguyen@gmail.com"));
        studentList.add(new Student("SV002", "Trần Thị Bích", LocalDate.parse("22/10/2001", ShopValidate.DATE_FORMATTER), Gender.FEMALE, "0912345678", "bich.tran@gmail.com"));
        studentList.add(new Student("SV003", "Lê Hoàng Cường", LocalDate.parse("05/02/1999", ShopValidate.DATE_FORMATTER), Gender.MALE, "0909123456", "cuong.le@gmail.com"));
        studentList.add(new Student("SV004", "Phạm Quỳnh Như", LocalDate.parse("30/08/2002", ShopValidate.DATE_FORMATTER), Gender.FEMALE, "0933445566", "nhu.pham@gmail.com"));
        studentList.add(new Student("SV005", "Đinh Tuấn Đạt", LocalDate.parse("12/12/2000", ShopValidate.DATE_FORMATTER), Gender.MALE, "0888999777", "dat.dinh@gmail.com"));

        System.out.println(ShopValidate.ANSI_GREEN + "Đã tải 5 dữ liệu sinh viên mẫu thành công!" + ShopValidate.ANSI_RESET);
    }
    ...
    private static void addNewStudent() {
        ...
        newStudent.inputData(studentList);
